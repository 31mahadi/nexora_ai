...
export const SEGMENT_ICONS: { value: string; label: string; emoji: string; group: string }[] = [
  ...
  { value: "figma", label: "Figma", emoji: "🎨", group: "Languages & Frameworks" },
  { value: "vercel", label: "Vercel", emoji: "▲", group: "Languages & Frameworks" },
  { value: "github", label: "GitHub", emoji: "⌨", group: "Languages & Frameworks" },
  { value: "npm", label: "NPM", emoji: "📦", group: "Languages & Frameworks" },
  { value: "yarn", label: "Yarn", emoji: "🧶", group: "Languages & Frameworks" },
  { value: "pnpm", label: "PNPM", emoji: "📦", group: "Languages & Frameworks" },
  { value: "vitest", label: "Vitest", emoji: "⚡", group: "Languages & Frameworks" },
  { value: "jest", label: "Jest", emoji: "✓", group: "Languages & Frameworks" },
  { value: "cypress", label: "Cypress", emoji: "🌲", group: "Languages & Frameworks" },
  { value: "playwright", label: "Playwright", emoji: "🎭", group: "Languages & Frameworks" },
  { value: "storybook", label: "Storybook", emoji: "📖", group: "Languages & Frameworks" },
  { value: "eslint", label: "ESLint", emoji: "✓", group: "Languages & Frameworks" },
  { value: "prettier", label: "Prettier", emoji: "✨", group: "Languages & Frameworks" },
  // Backend & Infra
  ...
  { value: "figma-design", label: "Figma", emoji: "🎨", group: "Design" },
  { value: "adobe", label: "Adobe", emoji: "🅰", group: "Design" },
  { value: "prototype", label: "Prototype", emoji: "📐", group: "Design" },
  { value: "wireframe", label: "Wireframe", emoji: "▦", group: "Design" },
  { value: "icon-design", label: "Icons", emoji: "◇", group: "Design" },
  { value: "illustration", label: "Illustration", emoji: "🖌", group: "Design" },
  { value: "animation", label: "Animation", emoji: "🎬", group: "Design" },
  { value: "3d", label: "3D", emoji: "◻", group: "Design" },
  // Data & Analytics
  ...
  { value: "bi", label: "BI", emoji: "📊", group: "Data & Analytics" },
  { value: "etl", label: "ETL", emoji: "🔄", group: "Data & Analytics" },
  { value: "ml", label: "Machine Learning", emoji: "🤖", group: "Data & Analytics" },
  { value: "nlp", label: "NLP", emoji: "💬", group: "Data & Analytics" },
  { value: "computer-vision", label: "Computer Vision", emoji: "👁", group: "Data & Analytics" },
  // Web & Mobile
  ...
  { value: "pwa", label: "PWA", emoji: "📱", group: "Web & Mobile" },
  { value: "ssr", label: "SSR", emoji: "🖥", group: "Web & Mobile" },
  { value: "cms", label: "CMS", emoji: "📝", group: "Web & Mobile" },
  { value: "ecommerce", label: "E-commerce", emoji: "🛒", group: "Web & Mobile" },
  { value: "payment", label: "Payments", emoji: "💳", group: "Web & Mobile" },
  // Tools & Testing
  ...
  { value: "vscode", label: "VS Code", emoji: "🖥", group: "Tools & Testing" },
  { value: "linear", label: "Linear", emoji: "▸", group: "Tools & Testing" },
  { value: "jira", label: "Jira", emoji: "📋", group: "Tools & Testing" },
  { value: "notion", label: "Notion", emoji: "📄", group: "Tools & Testing" },
  { value: "slack", label: "Slack", emoji: "💬", group: "Tools & Testing" },
  { value: "discord", label: "Discord", emoji: "🎮", group: "Tools & Testing" },
  { value: "confluence", label: "Confluence", emoji: "📚", group: "Tools & Testing" },
  { value: "postman", label: "Postman", emoji: "📮", group: "Tools & Testing" },
  { value: "insomnia", label: "Insomnia", emoji: "🌙", group: "Tools & Testing" },
  // Business & Other
  ...
  { value: "coaching", label: "Coaching", emoji: "🎯", group: "Business & Other" },
  { value: "training", label: "Training", emoji: "📚", group: "Business & Other" },
  { value: "mentoring", label: "Mentoring", emoji: "👤", group: "Business & Other" },
  { value: "auditing", label: "Auditing", emoji: "📋", group: "Business & Other" },
  { value: "consulting", label: "Consulting", emoji: "💼", group: "Business & Other" },
  { value: "freelance", label: "Freelance", emoji: "✏", group: "Business & Other" },
  { value: "remote", label: "Remote", emoji: "🏠", group: "Business & Other" },
  { value: "contract", label: "Contract", emoji: "📝", group: "Business & Other" },
  { value: "partnership", label: "Partnership", emoji: "🤝", group: "Business & Other" },
  { value: "growth", label: "Growth", emoji: "📈", group: "Business & Other" },
  { value: "innovation", label: "Innovation", emoji: "💡", group: "Business & Other" },
  { value: "agile", label: "Agile", emoji: "🔄", group: "Business & Other" },
  { value: "scrum", label: "Scrum", emoji: "📦", group: "Business & Other" },
  { value: "kanban", label: "Kanban", emoji: "▦", group: "Business & Other" },
];
...
/** Service icons use SEGMENT_ICONS (shared icon set). */
export const SERVICE_ICON_MAP: Record<string, string> = SEGMENT_ICON_MAP;
  ...
  if (type === "services") {
    return {
      ...
      settings: {
        title: "Services",
        subtitle: "",
        emptyMessage: "Add services below or from your admin profile.",
        columns: 2,
        columnsMobile: 0,
        serviceLayout: "grid",
        ...
        serviceGap: "md",
        serviceHoverEffect: "subtle",
        serviceTitleFontSize: "base",
        serviceTitleFontWeight: "semibold",
        serviceDescriptionFontSize: "sm",
        serviceDescriptionColor: "muted",
        serviceDescriptionCustomColor: "#52525b",
        serviceCardBorderRadius: "md",
        serviceCardBorder: "default",
        serviceCardBorderColor: "neutral",
        serviceCardBorderCustomColor: "#d4d4d8",
        serviceCardBgColor: "default",
        serviceIconPosition: "top",
        serviceIconAlign: "left",
        serviceIconSize: "md",
        serviceCardBgCustomColor: "#ffffff",
        maxServices: 0,
        items: [],
        servicesDataSource: "auto",
        servicesHeaderAlign: "left",
        servicesTitleFontFamily: "inherit",
        servicesTitleFontSize: "inherit",
        servicesTitleFontWeight: "bold",
        servicesTitleColor: "inherit",
        servicesTitleCustomColor: "#18181b",
        servicesSubtitleFontFamily: "inherit",
        servicesSubtitleFontSize: "inherit",
        servicesSubtitleFontWeight: "inherit",
        servicesSubtitleColor: "inherit",
        servicesSubtitleCustomColor: "#52525b",
        headerGap: "md",
        sectionBgColor: "none",
        sectionBgCustomColor: "#fafafa",
        sectionPadding: "md",
